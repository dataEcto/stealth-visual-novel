...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterOrientation3D : CharacterAbility
    {
        ...
        //public GameObject ViewVisualizationModel;
        ...
        protected Quaternion _newFOVQuaternion;
        ...
        protected virtual void RotateToFaceMovementDirection()
        {
            ...
            if (MovementRotationSpeed == RotationSpeeds.Instant)
            {
                if (_currentDirection != Vector3.zero)
                {
                    ...
                    _newFOVQuaternion = Quaternion.LookRotation(_currentDirection);
                }
            }
            ...
            if (MovementRotationSpeed == RotationSpeeds.Smooth)
            {
                if (_currentDirection != Vector3.zero)
                {
                    ...
                    //_newFOVQuaternion = Quaternion.Slerp(ViewVisualizationModel.transform.rotation, _tmpRotation, Time.deltaTime * RotateToFaceMovementDirectionSpeed);
                }                
            }
		...
		protected virtual void RotateToFaceWeaponDirection()
        {
            ...
            if (WeaponRotationSpeed == RotationSpeeds.Instant)
            {
                ...
                {                    
                    ...
                    _newFOVQuaternion = Quaternion.LookRotation(_rotationDirection);
                }
            }
            ...
            if (WeaponRotationSpeed == RotationSpeeds.Smooth)
            {
                if (_rotationDirection != Vector3.zero)
                {
                    ...
                    //_newFOVQuaternion = Quaternion.Slerp(ViewVisualizationModel.transform.rotation, _tmpRotation, Time.deltaTime * RotateToFaceWeaponDirectionSpeed);
                }
            }
        ...
        protected virtual void RotateModel()
        {
            ...
            //ViewVisualizationModel.transform.rotation = _newFOVQuaternion;
